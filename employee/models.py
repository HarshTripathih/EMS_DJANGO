...
class EmployeeExperience(models.Model):
    ...
    company1deg = models.CharField(max_length=100,null=True)
    ...
    company2deg = models.CharField(max_length=100,null=True)
    ...
    company3deg = models.CharField(max_length=100,null=True)
